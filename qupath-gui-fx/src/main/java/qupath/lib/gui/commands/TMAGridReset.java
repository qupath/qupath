 ...
 *
 */
public class TMAGridReset implements PathCommand {
	
	private final static Logger logger = LoggerFactory.getLogger(TMAGridReset.class);
	
	private QuPathGUI qupath;
	
	public TMAGridReset(final QuPathGUI qupath) {
		this.qupath = qupath;
	}
