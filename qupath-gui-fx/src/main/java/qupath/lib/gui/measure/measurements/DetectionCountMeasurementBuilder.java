 ...
 */
abstract class DetectionCountMeasurementBuilder implements NumericMeasurementBuilder {

    private final Function<PathObject, DetectionPathClassCounts> countsFunction;

    DetectionCountMeasurementBuilder(Function<PathObject, DetectionPathClassCounts> countsFunction) {
