...
import qupath.lib.images.servers.ImageServerMetadata.OutputType;
...
//		boolean useDisplayCache = imageDisplay != null && !server.isRGB() && server.nChannels() > 1;
		boolean useDisplayCache = !server.isRGB() && server.nChannels() > 1 && server.getOutputType() != OutputType.CLASSIFICATION;
