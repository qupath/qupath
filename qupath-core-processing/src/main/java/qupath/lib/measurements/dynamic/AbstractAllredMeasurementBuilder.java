 ...
 */
abstract class AbstractAllredMeasurementBuilder extends DetectionCountMeasurementBuilder {
     ...
     */
    AbstractAllredMeasurementBuilder(Function<PathObject, DetectionPathClassCounts> countsFunction,
