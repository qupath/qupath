...
public class PathObjectLazyValues {
     ...
     */
    public static final LazyStringValue CLASSIFICATION = new PathClassValue();
     ...
     */
    public static final LazyStringValue PARENT_DISPLAYED_NAME = new ParentNameValue();

    /**
     * Measurement to extract the type of an object (e.g. Annotation, Detection, Cell).
     */
    public static final LazyStringValue OBJECT_TYPE = new ObjectTypeValue();

    /**
     * Measurement to extract the unique ID of an object, as a string.
     */
    public static final LazyStringValue OBJECT_ID = new ObjectIdValue();

    /**
     * Measurement to extract the name of an object.
     */
    public static final LazyStringValue OBJECT_NAME = new ObjectNameValue();
     ...
     */
    public static final LazyStringValue TMA_CORE_NAME = new TMACoreNameValue();

    /**
     * Measurement to extract the name of a ROI type (e.g. Polygon, Rectangle).
     */
    public static final LazyStringValue ROI_TYPE = new ROINameValue();
     ...
     * @return
     */
    public static LazyStringValue createImageNameMeasurement(ImageData<?> imageData) {
        return new ImageNameValue(imageData);
    }


    public static LazyValue<Boolean> TMA_CORE_MISSING = new MissingTMACoreValue();

    public static LazyNumericValue ROI_Z_SLICE = new ZSliceValue();

    public static LazyNumericValue ROI_TIMEPOINT = new TimepointValue();

    public static LazyNumericValue ROI_NUM_POINTS = new NumPointsValue();
     ...
     * @return
     */
    public static LazyNumericValue createROICentroidX(ImageData<?> imageData) {
     ...
     * @return
     */
    public static LazyNumericValue createROICentroidY(ImageData<?> imageData) {
     ...
     * @return
     */
    public static LazyNumericValue createROIAreaMeasurement(ImageData<?> imageData) {
     ...
     * @return
     */
    public static LazyNumericValue createROIPerimeterMeasurement(ImageData<?> imageData) {
     ...
     * @return
     */
    public static LazyNumericValue createROILengthMeasurement(ImageData<?> imageData) {
     ...
     * @return
     */
    public static LazyNumericValue createDetectionCountMeasurement(ImageData<?> imageData) {
     ...
     * @return
     */
    public static LazyNumericValue createLivePixelClassificationMeasurement(PixelClassificationMeasurementManager manager, String name) {
        return new PixelClassifierValue(manager, name);
    }


    public static LazyStringValue createMetadataMeasurement(String name) {
        return new StringMetadataValue(name);
    }

    public static LazyNumericValue createMeasurementListMeasurement(String name) {
        return new MeasurementListValue(name);
    }


    public static LazyNumericValue createHScoreMeasurement(
            ImageData<?> imageData,
            PathClass... pathClasses) {
        return new HScoreValue(getCountsFunction(imageData), pathClasses);
    }

    public static LazyNumericValue createPositivePercentageMeasurement(
            ImageData<?> imageData,
            PathClass... pathClasses) {
        return new PositivePercentageValue(getCountsFunction(imageData), pathClasses);
    }

    public static LazyNumericValue createDetectionClassDensityMeasurement(
            ImageData<?> imageData,
            PathClass pathClass) {
        return new ClassDensityValue(getCountsFunction(imageData), imageData, pathClass);
    }

    public static LazyNumericValue createBaseClassCountsMeasurement(
            ImageData<?> imageData,
            PathClass pathClass) {
        return new DetectionClassificationsCountValue(getCountsFunction(imageData), pathClass, true);
    }

    public static LazyNumericValue createExactClassCountsMeasurement(
            ImageData<?> imageData,
            PathClass pathClass) {
        return new DetectionClassificationsCountValue(getCountsFunction(imageData), pathClass, false);
    }

    public static LazyNumericValue createAllredIntensityMeasurement(
            ImageData<?> imageData,
    ...
    public static LazyNumericValue createAllredProportionMeasurement(
            ImageData<?> imageData,
            Supplier<Double> allredMinPercentage,
            PathClass... pathClasses) {
    ...
    public static LazyNumericValue createAllredMeasurement(
            ImageData<?> imageData,
            Supplier<Double> allredMinPercentage,
            PathClass... pathClasses) {
