...
/**
 * Abstract implementation of {@link OpenCVStatModel} that is based upon {@link StatModel},
 * part of the OpenCV machine learning module.
 * @param <T>
 */
abstract class AbstractOpenCVClassifierML<T extends StatModel> implements OpenCVStatModel {

    private static final Logger logger = LoggerFactory.getLogger(AbstractOpenCVClassifierML.class);
