...
import qupath.lib.classifiers.opencv.OpenCVMLClassifier;
 ...
 *
 */
public class OpenCvClassifierCommand2 implements PathCommand {
	...
	public OpenCvClassifierCommand2(final QuPathGUI qupath) {
		this.qupath = qupath;
	}
